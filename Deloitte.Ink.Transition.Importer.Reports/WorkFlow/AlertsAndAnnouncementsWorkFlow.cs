...
{
    internal class AlertsAndAnnouncementsWorkFlow : Workflows, IPracticalGuideWorkflow
    {
        public readonly IPracticalGuideService _practGuideService;
        public readonly ITransitionCoreServices _coreService;
        public AlertsAndAnnouncementsWorkFlow(ITransitionCoreServices coreServices, ILogger<IPracticalGuideWorkflow> logger, IPracticalGuideService _manualRepService) : base(coreServices)
        {
