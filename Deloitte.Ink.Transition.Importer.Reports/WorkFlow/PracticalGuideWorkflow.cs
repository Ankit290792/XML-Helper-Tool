...
{
    internal class PracticalGuideWorkflow : Workflows, IPracticalGuideWorkflow
    {
        public readonly IPracticalGuideService _practGuideService;
        public readonly ITransitionCoreServices _coreService;
        public PracticalGuideWorkflow(ITransitionCoreServices coreServices, ILogger<IPracticalGuideWorkflow> logger, IPracticalGuideService _manualRepService) : base(coreServices)
        {
